...
Lovely, isn't it?  This is how Perl prints UTF-8.  To make it "pretty," you can
...
B<Warning: creating L<DateTime> objects is extremely slow.  They are very 
complex and heavyweight.  For most applications, it may make more sense to save
dates as numbers and the convert the numbers to L<DateTime>s when needed.  A single
